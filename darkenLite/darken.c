...
{
    EXEC(this, this->state = state, "set: invalid entity");
}

de_entity *de_entity_destructor(de_entity *const this, de_state state)
{
    EXEC(this, this->destructor = state, "destroy: invalid entity");
}

de_entity *de_entity_delete(de_entity *const this)
{
    EXEC(this, this->state = 0, "delete: invalid entity");
}
