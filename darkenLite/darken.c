...
de_entity *de_entity_set       (de_entity *const this, de_state state) { return this->state      = state, this; }
de_entity *de_entity_destructor(de_entity *const this, de_state state) { return this->destructor = state, this; }
de_entity *de_entity_delete    (de_entity *const this)                 { return de_entity_set(this, 0);         }
